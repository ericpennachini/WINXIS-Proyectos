...
namespace TestFacturaElectronica.Dominio.LoginWS {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="LoginWS.LoginCMS")]
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(TestFacturaElectronica.Dominio.LoginWS.LoginFault), Action="", Name="fault")]
        TestFacturaElectronica.Dominio.LoginWS.loginCmsResponse loginCms(TestFacturaElectronica.Dominio.LoginWS.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : TestFacturaElectronica.Dominio.LoginWS.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<TestFacturaElectronica.Dominio.LoginWS.LoginCMS>, TestFacturaElectronica.Dominio.LoginWS.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestFacturaElectronica.Dominio.LoginWS.loginCmsResponse TestFacturaElectronica.Dominio.LoginWS.LoginCMS.loginCms(TestFacturaElectronica.Dominio.LoginWS.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            TestFacturaElectronica.Dominio.LoginWS.loginCmsRequest inValue = new TestFacturaElectronica.Dominio.LoginWS.loginCmsRequest();
            inValue.in0 = in0;
            TestFacturaElectronica.Dominio.LoginWS.loginCmsResponse retVal = ((TestFacturaElectronica.Dominio.LoginWS.LoginCMS)(this)).loginCms(inValue);
