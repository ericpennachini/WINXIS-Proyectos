...
namespace TestFacturaElectronicaDominio.LoginWS {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(TestFacturaElectronicaDominio.LoginWS.LoginFault), Action="", Name="fault")]
        TestFacturaElectronicaDominio.LoginWS.loginCmsResponse loginCms(TestFacturaElectronicaDominio.LoginWS.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : TestFacturaElectronicaDominio.LoginWS.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<TestFacturaElectronicaDominio.LoginWS.LoginCMS>, TestFacturaElectronicaDominio.LoginWS.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        TestFacturaElectronicaDominio.LoginWS.loginCmsResponse TestFacturaElectronicaDominio.LoginWS.LoginCMS.loginCms(TestFacturaElectronicaDominio.LoginWS.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            TestFacturaElectronicaDominio.LoginWS.loginCmsRequest inValue = new TestFacturaElectronicaDominio.LoginWS.loginCmsRequest();
            inValue.in0 = in0;
            TestFacturaElectronicaDominio.LoginWS.loginCmsResponse retVal = ((TestFacturaElectronicaDominio.LoginWS.LoginCMS)(this)).loginCms(inValue);
